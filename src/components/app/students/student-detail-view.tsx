...
export function StudentDetailView({ id, onBack }: StudentDetailViewProps) {
    ...
    return (
        <div className="flex flex-col gap-8">
            ...
            <div className="bg-white border border-slate-200/60 rounded-[2.5rem] px-10 py-5 shadow-[0_20px_50px_-12px_rgba(0,0,0,0.04)] flex flex-col xl:flex-row gap-8 items-center xl:items-stretch transition-all hover:shadow-[0_30px_60px_-15px_rgba(0,0,0,0.06)] relative overflow-hidden group">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-x-12 gap-y-5 flex-1 w-full relative pt-1">
                    ...
                    <div className="space-y-6">
                        <InfoItem icon={User} label="부모님 성함" value="-" />
                        <InfoItem icon={Phone} label="부모님 연락처" value="010-5056-0676" />
                    </div>
            ...
            <Tabs defaultValue={defaultTab} className="w-full">
                        ...
                        <CardContent className="p-0 flex flex-col gap-8">
                            <div className="flex flex-col gap-6">
                                ...
                                <div className="bg-white border border-slate-100 rounded-3xl p-8 shadow-[0_4px_25px_-5px_rgba(0,0,0,0.02)] flex flex-col gap-8">
                                    ...
                                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-x-12 gap-y-6">
                                        <FormField label="학생 이름" required>
                                            <Input defaultValue="진방울" className="bg-slate-50 border-slate-100 rounded-xl h-11" />
                                        </FormField>
                                        <FormField label="핀번호">
                                            <Input defaultValue="0006" className="bg-slate-50 border-slate-100 rounded-xl h-11" />
                                        </FormField>
                                        <FormField label="아이디">
                                            <Input placeholder="입력하십시오" className="bg-slate-50 border-slate-100 rounded-xl h-11" />
                                        </FormField>
                                        <FormField label="비밀번호">
                                            <div className="flex gap-2">
                                                <div className="relative flex-1">
                                                    <Input type="password" placeholder="입력하십시오" className="bg-slate-50 border-slate-100 rounded-xl h-11" />
                                                    <Lock className="absolute right-3 top-3.5 w-4 h-4 text-slate-300" />
                                                </div>
                                                <Button className="bg-[#002855] hover:bg-[#001d3d] text-white font-bold rounded-xl h-11 px-6 px-4 whitespace-nowrap">비밀번호 초기화</Button>
                                            </div>
                                        </FormField>
                                        ...
                                        <FormField label="연락처">
                                            <Input defaultValue="01050560676" className="bg-slate-50 border-slate-100 rounded-xl h-11" />
                                        </FormField>
                                            ...
                                            <FormField label="학습타입">
                                                <Select defaultValue="both">
                                                    ...
                                                    <SelectContent>
                                                        ...
                                                        <SelectItem value="read">책 읽기</SelectItem>
                                                        <SelectItem value="write">글쓰기</SelectItem>
                                                    </SelectContent>
                                                </Select>
                                            </FormField>
                                    ...
                                    {/* Admin Memo Section */}
                                    <div className="pt-8 border-t border-slate-50">
                                        <SectionHeader title="기관관리자에게만 노출되는 정보" />
                                        <div className="mt-6">
                                            <FormField label="메모">
                                                <Textarea placeholder="입력하십시오" className="bg-slate-50 border-slate-100 rounded-2xl min-h-[120px] focus:bg-white transition-all" />
                                            </FormField>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className="flex justify-between items-center mt-4">
                                    <Button onClick={onBack} variant="outline" className="h-12 px-8 border-slate-200 text-slate-500 font-bold rounded-2xl hover:bg-slate-50 transition-all">목록</Button>
                                    <Button className="h-12 px-10 bg-[#002855] hover:bg-[#001d3d] text-white font-bold rounded-2xl shadow-lg shadow-blue-900/10 transition-all">저장</Button>
                                </div>
                            </div>
                        </CardContent>
                    </Card>
                ...
                {["study", "report", "video", "logs"].map((tab) => (
