...
export function ConfirmModal({ title, description, cancelLabel = "취소", confirmLabel, single = false, onClose, onCancel = onClose, onConfirm }: { title: string; description: React.ReactNode; cancelLabel?: string; confirmLabel: string; single?: boolean; onClose: () => void; onCancel?: () => void; onConfirm: () => void }) {
